...
export default function EditCarPage() {
  ...
  React.useEffect(() => {
    ...
    } else if (form.getValues('image')) {
      // If there's an image path but no selected file, show the existing image
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      alert('Gagal memperbarui mobil. Silakan coba lagi.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <AdminHeader />      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <Button
          variant="ghost"
                        ...
                        <FormItem className="col-span-2">
                          ...
                          <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-2">
                              ...
                              <Input
                                placeholder="/images/cars/avanza.png"
                                value={field.value}
                          ...
                          <FormDescription>
                            Upload gambar mobil atau masukkan path relatif ke file gambar dalam folder public
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
